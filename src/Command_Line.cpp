...
Command_Line::Command_Line()
{
    options = 
            ...
            "\t\tNotice that probing is supported only in static MSPAI without any\n"
            "\t\timprovement steps.\n"
            "\t\tdefault is no file\n"
            "\n"  
            ...
            "\n"
            "\t  -cs:  cache size for runtime-optimization within MSPAI. Allowed are:\n"
            "\t\t0: not using cache (default)\n"
            "\t\t0 < cs < 1e+7 for using cache with cs-size.\n"
            "\t\tdefault is cs = 0.\n"
            "\n"
            "\t  -qr:  Use QR-Updates for runtime-optimization within MSPAI. Allowed are:\n"
	    ...
	    "\t\tdefault is qr = 0\n"
            ...
            "\t\tThis hashtable is used for comparison with the caching algorithm.\n"
...
void
Command_Line::Print_Short_License()
{
    std::cout << "\n\t==========================================================="  
...
void 
Command_Line::Parameters(int    argc, 
                         char   *argv[],
                         char   *&matrix_file,
                         char   *&pattern_file,
                         int    &pp,
...
int 
Command_Line::Match_Arg(char *string)
{
    int     k = 0;
