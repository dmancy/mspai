...
public:
    ...
    /////////////////////////////////////////////////////
    void Communicate(Matrix<T>* A, Matrix<T>*& M, Matrix<T>* B, Pattern* P, Pattern* UP);
    ...
    ///     \param UP Local upper pattern chunk
    /////////////////////////////////////////////////////
    void Say_Im_Done(Matrix<T>* A, Matrix<T>*& M, Matrix<T>* B, Pattern* P, Pattern* UP);

    void Say_Im_Done_Prefetching(Matrix<T>* A, Matrix<T>*& M, Matrix<T>* B, Pattern* P, Pattern* UP);
    ...
    /////////////////////////////////////////////////////
    bool Get_M_Col(Matrix<T>* A, Matrix<T>* M, Matrix<T>* B, Pattern* P, Pattern* UP, const int pe, int& index);
...
private:
    ...
    /////////////////////////////////////////////////////
    void Handle_Im_Done(Matrix<T>* A, int requestor);

    void Handle_Im_Done_Pre(Matrix<T>* A, int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Done_Signal(Matrix<T>* A, int requestor);

    void Handle_Done_Signal_Pre(Matrix<T>* A, int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_Target_Col(const Matrix<double>* B, const int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Insert_Row_Solution(Matrix<double>* M, int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_Col(const Matrix<COMPLEX>* A, const int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_Target_Col(const Matrix<COMPLEX>* B, const int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Insert_Row_Solution(Matrix<COMPLEX>* M, int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_M_Col(Pattern* P, int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_P_Col(const Matrix<T>* A, const Pattern* P, const int requestor);
    ...
    ///     \param requestor Pe which invoked this handle
    /////////////////////////////////////////////////////
    void Handle_Get_UP_Col(const Matrix<T>* A, const Pattern* UP, const int requestor);
};
