...
private:
    ...
    ///                be solved
    ///     \param nnz Number of nnz of current submatrix
    ///////////////////////////////////////////////////////////
    void Approximative_Solution(
        T* A_Hat_orig, int& m, int& n, T*& mk_Hat, const Index_Set* I, const int col, const int nnz);
