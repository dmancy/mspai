...
template<>
Pattern* 
Pattern_Switch<double>::Generate_Pattern(Matrix<double>*  mtx,
                                    char*       pattern_file,
                                    int         pattern_param,
                                    const int   use_schur,
                                    const int   prob_Ce_N,
...
{    
    ...
    switch(pattern_param)
    {
        case 0: //Own pattern file
            P = P->Arbitrary_Pattern(pattern_file, mtx->n, 
                                     use_schur, prob_Ce_N, mtx->world);
            break;
                    
        case 1: //Diagonal pattern
            P = P->Diagonal_Pattern(mtx->n, mtx->my_nbr_cols, 
                                    mtx->my_start_idx, mtx->world);
            break;
