...
struct Col_Comparator {
    ...
    {
        if ((a.j < b.j) || ((a.j == b.j) && (a.i < b.i)) || ((a.j == b.j) && (a.i == b.i)))
            return true;
...
struct Row_Comparator {
    ...
    bool operator()(const T& a, const T& b)
    {
        if ((a.i < b.i) || ((a.i == b.i) && (a.j < b.j)) || ((a.i == b.i) && (a.j == b.j)))
            return true;
...
public:
    ...
    ///                      hermitian or not
    //////////////////////////////////////////////////////
    void Read_Header(FILE* f, int& type, bool& symmetric, bool& hermitian);
    ...
    //////////////////////////////////////////////////////
    int Get_Matrix_Type(char* matrix_file, bool& symmetric, bool& hermitian);
...
private:
    ...
    ///                pattern
    ///////////////////////////////////////////////////////////
    void Count_NNZ_Cols(RCV const* in, size_t size, int* out);
    ...
    ///                pattern
    ///////////////////////////////////////////////////////////
    void Count_NNZ_Rows(RCV const* in, size_t size, int* out);
    ...
    ///                pattern
    ///////////////////////////////////////////////////////////
    void Count_NNZ_Cols(RCC const* in, size_t size, int* out);
    ...
    ///                pattern
    ///////////////////////////////////////////////////////////
    void Count_NNZ_Rows(RCC const* in, size_t size, int* out);
};
#endif
