...
public:
    ...
    T* Convert_block_AHat(T* A_Hat, Matrix<T>* A, Index_Set* J, Index_Set* I);
    T* Convert_block_mHat(T* m_Hat, Matrix<T>* A, int col, Index_Set* I);

    void Get_Solution_Vals_Block(T* mk_Hat_in,
                                 T* mk_Hat_out,
                                 const Matrix<T>* M,
                                 const Matrix<T>* A,
                                 const int col,
    ...
    //////////////////////////////////////////////////////////////
    cs* Convert_Matrix_toCS(T*& in_matrix, const int m, const int n, const int nnz);
    ...
    //////////////////////////////////////////////////////////////
    double Compute_Fillgrade(const int nnz, const int m, const int n);
    ...
    ///     \param n n-dimension of the input matrix
    //////////////////////////////////////////////////////////////
    void Ectract_Quadratic_Content(T* matrix, const size_t m, const size_t n);
    ...
    //////////////////////////////////////////////////////////////
    void Insert_Row_Solution(Matrix<T>* A, Matrix<T>*& M, const int col, const T* mk_Hat, const Index_Set* J);
    ...
    //////////////////////////////////////////////////////////////
    bool Compare_A_Hat(T* A1, T* A2, int dim);
    ...
    //////////////////////////////////////////////////////////////
    int Opt_lwork_QRDecomp(double* A_hat, int m, int n);
    ...
    ///                      is to be set
    //////////////////////////////////////////////////////////////
    void Set_Unit_Idx(double*& vec, int unit_idx);
    ...
    //////////////////////////////////////////////////////////////
    void Print_A_Hat(const double* A_Hat, const int n, const int m);
    ...
    //////////////////////////////////////////////////////////////
    bool Compare_aij(double d1, double d2);
    ...
    ///     \return The optimal work size
    //////////////////////////////////////////////////////////////
    int Opt_lwork_QRDecomp(COMPLEX* A_hat, int m, int n);
    ...
    ///                      is to be set
    //////////////////////////////////////////////////////////////
    void Set_Unit_Idx(COMPLEX*& vec, int unit_idx);
    ...
    ///                data (e.g: The name of the vector)
    //////////////////////////////////////////////////////////////
    void Print_Vector(const COMPLEX* vector, const int len, const char* str);
    ...
    ///     \param m The m-dimension of the submatrix (rows)
    //////////////////////////////////////////////////////////////
    void Print_A_Hat(const COMPLEX* A_Hat, const int n, const int m);
