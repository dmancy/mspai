                            ...
                            MPI_Comm    world)
{
    ...
    Read_Pattern_Data(  f, file_nnz, my_nbr_cols,
                        start_idx, &cols, &nnz_cols,
                        symmetric);

    
    P = Data_To_Pattern( file_N, cols, nnz_cols, 
                         my_nbr_cols, world);
...
void
Pattern::Read_Pattern_Header(   FILE *&f, 
                                int &file_M, 
                                int &file_N, 
                                int &file_nnz,
                                bool &symmetric)
...
void 
Pattern::Read_Pattern_Data( FILE    *f,
                            int     file_nnz,
                            int     my_nbr_cols,
                            int     start_idx,
                            RC      **cols,
...
Pattern * 
Pattern::Data_To_Pattern(   int file_N,
                            RC  *cols,
                            int nnz_cols,
                            int my_nbr_cols,
                            MPI_Comm world)
...
void 
Pattern::Count_NNZ_Cols(RC const    *in, 
                        size_t      size, 
                        int         *out)
{
...
void 
Pattern::Count_NNZ_Rows(RC const *in, 
                        size_t  size, 
                        int     *out)
{
    // Columns with no nnz will be
...
Pattern * 
Pattern::Diagonal_Pattern(const int file_N,
                          int my_nbr_cols, 
                          int start_idx,
                          MPI_Comm  world)
{
