...
#ifndef GUARD_SPAI_CACHING_H
#define GUARD_SPAI_CACHING_H
...
/////////////////////////////////////////////////////////////
///     \class Spai_Caching
///     \brief  Implementing the SPAI Caching algorithm 
///
///     This is the spai algorithm using a cache to extract 
...
///     5)  Look in cache if this submatrix was previously
///         and return its position in cache \n   
///     6)  Solve the least squares solution: \n
///     7.1)  If the cache index is greater than zero proceed 
///           with point 8) \n
///     7.2)  If the cache index is -1 proceed with point 9) \n
///     8)  Test if even the rhs vector is identical \n   
...
/////////////////////////////////////////////////////////////
template <class T>
class Spai_Caching : public Spai<T>
{
    public:
        ...
        ///     \brief Constructor
        ///
        ///     \param cache_size The size 
        ///                       of the cache
        ////////////////////////////////////////
        Spai_Caching(const int cache_size);
    ...
    private:
        ...
        ///                solved
        ///     \param cache_key The key of the submatrix if found
        ///                      in cache
        ///     \param bk_Hat_key The key of the right hand side of
        ///                       LS problem
        ///     \param cache_el The cache index of the submatrix 
        ///////////////////////////////////////////////////////////
